...
public class PropertiesLoader {
    ...
    public static void main(String[] args)throws Exception {
    	int timeout = PropertiesLoader.getPropertyLoader("application.properties").getInteger("fdfs.connect_timeout", 0);
    	System.out.println(timeout);
    	String url = PropertiesLoader.getPropertyLoader("spring/jdbc.properties").getString("url", "");
